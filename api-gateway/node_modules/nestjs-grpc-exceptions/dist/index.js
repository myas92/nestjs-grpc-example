...
var require_throwError = __commonJS({
  "node_modules/.pnpm/rxjs@7.8.0/node_modules/rxjs/dist/cjs/internal/observable/throwError.js"(exports) {
    ...
    var Observable_1 = require_Observable();
    var isFunction_1 = require_isFunction();
    function throwError4(errorOrErrorFactory, scheduler) {
    ...
    exports.throwError = throwError4;
  }
});
...
// index.ts
var nestjs_grpc_exceptions_exports = {};
__export(nestjs_grpc_exceptions_exports, {
  GrpcAbortedException: () => GrpcAbortedException,
  GrpcAlreadyExistsException: () => GrpcAlreadyExistsException,
  GrpcCancelledException: () => GrpcCancelledException,
  GrpcInternalException: () => GrpcInternalException,
  GrpcInvalidArgumentException: () => GrpcInvalidArgumentException,
  GrpcNotFoundException: () => GrpcNotFoundException,
  GrpcPermissionDeniedException: () => GrpcPermissionDeniedException,
  GrpcResourceExhaustedException: () => GrpcResourceExhaustedException,
  GrpcServerExceptionFilter: () => GrpcServerExceptionFilter,
  GrpcToHttpInterceptor: () => GrpcToHttpInterceptor,
  GrpcUnauthenticatedException: () => GrpcUnauthenticatedException,
  GrpcUnavailableException: () => GrpcUnavailableException,
  GrpcUnknownException: () => GrpcUnknownException,
  HttpToGrpcInterceptor: () => HttpToGrpcInterceptor
});
module.exports = __toCommonJS(nestjs_grpc_exceptions_exports);

// lib/filters/grpc-server-exception.filter.ts
var import_common = require("@nestjs/common");
var import_microservices = require("@nestjs/microservices");
var import_rxjs = __toESM(require_cjs());
var GrpcServerExceptionFilter = class {
  catch(exception) {
    return (0, import_rxjs.throwError)(() => exception.getError());
  }
};
GrpcServerExceptionFilter = __decorateClass([
  (0, import_common.Catch)(import_microservices.RpcException)
], GrpcServerExceptionFilter);

// lib/exceptions/not-found.exception.ts
var import_grpc_js2 = require("@grpc/grpc-js");
var import_microservices3 = require("@nestjs/microservices");

// lib/utils/error-object.ts
var import_microservices2 = require("@nestjs/microservices");
function errorObject(error, code) {
  return {
    message: JSON.stringify({
      error,
      type: typeof error === "string" ? "string" : "object",
      exceptionName: import_microservices2.RpcException.name
    }),
    code
  };
}

// lib/utils/http-codes-map.ts
var import_grpc_js = require("@grpc/grpc-js");
var import_common2 = require("@nestjs/common");
var HTTP_CODE_FROM_GRPC = {
  [import_grpc_js.status.OK]: import_common2.HttpStatus.OK,
  [import_grpc_js.status.CANCELLED]: import_common2.HttpStatus.METHOD_NOT_ALLOWED,
  [import_grpc_js.status.UNKNOWN]: import_common2.HttpStatus.BAD_GATEWAY,
  [import_grpc_js.status.INVALID_ARGUMENT]: import_common2.HttpStatus.UNPROCESSABLE_ENTITY,
  [import_grpc_js.status.DEADLINE_EXCEEDED]: import_common2.HttpStatus.REQUEST_TIMEOUT,
  [import_grpc_js.status.NOT_FOUND]: import_common2.HttpStatus.NOT_FOUND,
  [import_grpc_js.status.ALREADY_EXISTS]: import_common2.HttpStatus.CONFLICT,
  [import_grpc_js.status.PERMISSION_DENIED]: import_common2.HttpStatus.FORBIDDEN,
  [import_grpc_js.status.RESOURCE_EXHAUSTED]: import_common2.HttpStatus.TOO_MANY_REQUESTS,
  [import_grpc_js.status.FAILED_PRECONDITION]: import_common2.HttpStatus.PRECONDITION_REQUIRED,
  [import_grpc_js.status.ABORTED]: import_common2.HttpStatus.METHOD_NOT_ALLOWED,
  [import_grpc_js.status.OUT_OF_RANGE]: import_common2.HttpStatus.PAYLOAD_TOO_LARGE,
  [import_grpc_js.status.UNIMPLEMENTED]: import_common2.HttpStatus.NOT_IMPLEMENTED,
  [import_grpc_js.status.INTERNAL]: import_common2.HttpStatus.INTERNAL_SERVER_ERROR,
  [import_grpc_js.status.UNAVAILABLE]: import_common2.HttpStatus.NOT_FOUND,
  [import_grpc_js.status.DATA_LOSS]: import_common2.HttpStatus.INTERNAL_SERVER_ERROR,
  [import_grpc_js.status.UNAUTHENTICATED]: import_common2.HttpStatus.UNAUTHORIZED
};

// lib/exceptions/not-found.exception.ts
var GrpcNotFoundException = class extends import_microservices3.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js2.status.NOT_FOUND));
  }
};

// lib/exceptions/aborted.exception.ts
var import_grpc_js3 = require("@grpc/grpc-js");
var import_microservices4 = require("@nestjs/microservices");
var GrpcAbortedException = class extends import_microservices4.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js3.status.ABORTED));
  }
};

// lib/exceptions/unknown.exception.ts
var import_grpc_js4 = require("@grpc/grpc-js");
var import_microservices5 = require("@nestjs/microservices");
var GrpcUnknownException = class extends import_microservices5.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js4.status.UNKNOWN));
  }
};

// lib/exceptions/internal.exception.ts
var import_grpc_js5 = require("@grpc/grpc-js");
var import_microservices6 = require("@nestjs/microservices");
var GrpcInternalException = class extends import_microservices6.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js5.status.INTERNAL));
  }
};

// lib/exceptions/unavailable.exception.ts
var import_grpc_js6 = require("@grpc/grpc-js");
var import_microservices7 = require("@nestjs/microservices");
var GrpcUnavailableException = class extends import_microservices7.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js6.status.UNAVAILABLE));
  }
};

// lib/exceptions/unauthenticated.exception.ts
var import_grpc_js7 = require("@grpc/grpc-js");
var import_microservices8 = require("@nestjs/microservices");
var GrpcUnauthenticatedException = class extends import_microservices8.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js7.status.UNAUTHENTICATED));
  }
};

// lib/exceptions/permission-denied.exception.ts
var import_grpc_js8 = require("@grpc/grpc-js");
var import_microservices9 = require("@nestjs/microservices");
var GrpcPermissionDeniedException = class extends import_microservices9.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js8.status.PERMISSION_DENIED));
  }
};

// lib/exceptions/invalid-argument.exception.ts
var import_grpc_js9 = require("@grpc/grpc-js");
var import_microservices10 = require("@nestjs/microservices");
var GrpcInvalidArgumentException = class extends import_microservices10.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js9.status.INVALID_ARGUMENT));
  }
};

// lib/exceptions/resource-exhausted.exception.ts
var import_grpc_js10 = require("@grpc/grpc-js");
var import_microservices11 = require("@nestjs/microservices");
var GrpcResourceExhaustedException = class extends import_microservices11.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js10.status.RESOURCE_EXHAUSTED));
  }
};

// lib/exceptions/already-exists.exception.ts
var import_grpc_js11 = require("@grpc/grpc-js");
var import_microservices12 = require("@nestjs/microservices");
var GrpcAlreadyExistsException = class extends import_microservices12.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js11.status.ALREADY_EXISTS));
  }
};

// lib/exceptions/cancelled.exception.ts
var import_grpc_js12 = require("@grpc/grpc-js");
var import_microservices13 = require("@nestjs/microservices");
var GrpcCancelledException = class extends import_microservices13.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js12.status.CANCELLED));
  }
};

// lib/interceptors/grpc-to-http.interceptor.ts
var import_common3 = require("@nestjs/common");
var import_microservices14 = require("@nestjs/microservices");
var import_rxjs2 = __toESM(require_cjs());
var import_operators = __toESM(require_operators());
var GrpcToHttpInterceptor = class {
  intercept(_context, next) {
    return next.handle().pipe(
      (0, import_operators.catchError)((err) => {
        if (!(typeof err === "object" && "details" in err && err.details && typeof err.details === "string"))
          return (0, import_rxjs2.throwError)(() => err);
        const exception = JSON.parse(err.details);
        if (exception.exceptionName !== import_microservices14.RpcException.name)
          return (0, import_rxjs2.throwError)(() => err);
        const statusCode = HTTP_CODE_FROM_GRPC[err.code] || import_common3.HttpStatus.INTERNAL_SERVER_ERROR;
        return (0, import_rxjs2.throwError)(
          () => new import_common3.HttpException(
            {
              message: exception.error,
              statusCode,
              error: import_common3.HttpStatus[statusCode]
            },
            statusCode,
            {
              cause: err
...
GrpcToHttpInterceptor = __decorateClass([
...
var GRPC_EXCEPTION_FROM_HTTP = {
  [import_common4.HttpStatus.NOT_FOUND]: GrpcNotFoundException,
  [import_common4.HttpStatus.FORBIDDEN]: GrpcPermissionDeniedException,
  [import_common4.HttpStatus.METHOD_NOT_ALLOWED]: GrpcAbortedException,
  [import_common4.HttpStatus.INTERNAL_SERVER_ERROR]: GrpcInternalException,
  [import_common4.HttpStatus.TOO_MANY_REQUESTS]: GrpcResourceExhaustedException,
  [import_common4.HttpStatus.BAD_GATEWAY]: GrpcUnknownException,
  [import_common4.HttpStatus.CONFLICT]: GrpcAlreadyExistsException,
  [import_common4.HttpStatus.UNPROCESSABLE_ENTITY]: GrpcInvalidArgumentException,
  [import_common4.HttpStatus.UNAUTHORIZED]: GrpcUnauthenticatedException
};
var HttpToGrpcInterceptor = class {
  intercept(_context, next) {
    return next.handle().pipe(
      (0, import_operators2.catchError)((err) => {
        if (!(typeof err === "object" && "response" in err && err.response && "status" in err))
        ...
        return (0, import_rxjs3.throwError)(() => new Exception(exception.message));
      })
    );
  }
};
HttpToGrpcInterceptor = __decorateClass([
